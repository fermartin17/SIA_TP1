...
//implementación del método húngaro para resolver la asignación de mínimo costo de tareas
//implementación sacada de https://github.com/aalmi/HungarianAlgorithm/blob/master/HungarianAlgorithm.java
