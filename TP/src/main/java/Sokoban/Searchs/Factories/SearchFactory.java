...
public class SearchFactory {
    ...
    public static SearchMethod searchMethod(String[] params){
        ...
        switch (params[0]){
            ...
            case Constants.ConstantsValues.GGS: return new HPA<State>(1,HeuristicFactory.heuristic(params[1]));
            case Constants.ConstantsValues.A: return new HPA<State>(0.5,HeuristicFactory.heuristic(params[1]));
